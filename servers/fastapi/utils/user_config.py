...
def get_user_config():
    ...
    return UserConfig(
        ...
        STABLE_DIFFUSION_URL=existing_config.STABLE_DIFFUSION_URL or get_stable_diffusion_url_env(),
        TOOL_CALLS=(
...
def update_env_with_user_config():
    ...
    if user_config.STABLE_DIFFUSION_URL:
        set_stable_diffusion_url_env(user_config.STABLE_DIFFUSION_URL)
