...
export default function LLMProviderSelection({
  ...
  useEffect(() => {
    ...
    const needsApiKey =
      ...
      (llmConfig.IMAGE_PROVIDER === "stable_diffusion" && !llmConfig.STABLE_DIFFUSION_URL);
    ...
    setButtonState({
      ...
      text: needsModelSelection
        ...
        : needsApiKey
          ? (llmConfig.IMAGE_PROVIDER === "stable_diffusion" ? "Please Enter Stable Diffusion URL" : "Please Enter API Key")
          : needsOllamaUrl
      ...
      <div className="flex-1 overflow-y-auto p-6 pt-0 custom_scrollbar">
        ...
        {llmConfig.IMAGE_PROVIDER &&
          ...
          (() => {
            ...
            // Show API key or URL input for other providers
            return (
              <div className="mb-8">
                    ...
                    value={
                      provider.apiKeyField === "PEXELS_API_KEY"
                        ...
                        : provider.apiKeyField === "PIXABAY_API_KEY"
                          ...
                          : provider.apiKeyField === "STABLE_DIFFUSION_URL"
                            ? llmConfig.STABLE_DIFFUSION_URL || ""
                          : ""
                    }
                    onChange={(e) => {
                      ...
                      } else if (provider.apiKeyField === "STABLE_DIFFUSION_URL") {
                        input_field_changed(e.target.value, "stable_diffusion_url");
                      }
                    }}
                  />
                </div>
                <p className="mt-2 text-sm text-gray-500 flex items-center gap-2">
                  ...
                  {provider.value === "stable_diffusion" ? "URL for Stable Diffusion server" : `API key for ${provider.label} image generation`}
                </p>
              </div>
            );
          })()}
